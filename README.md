# 🚦 SignSense: Traffic Sign Learning Assistant
...
SignSense uses a **Hybrid CNN + Vision LLM pipeline**: A lightweight CNN (TensorFlow Lite) provides real-time prediction hints, and Groq-powered AI (Qwen3.6 27B for Vision and GPT OSS 120B for Chat) performs the final robust classification and generates contextual legal advice based on the Indian Motor Vehicles Act.
